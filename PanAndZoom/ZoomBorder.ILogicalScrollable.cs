...
public partial class ZoomBorder : ILogicalScrollable
{
    ...
    public static void CalculateScrollable(Rect source, Size borderSize, Matrix matrix, out Size extent,
        out Size viewport, out Vector offset)
    {
        ...
        if (width < viewport.Width)
        {
            ...
            else
            {
                ...
                if (widthTranslated > width) width += widthTranslated - width;
            }
        }
        ...
        if (height < viewport.Height)
        {
            ...
            else
            {
                ...
                if (heightTranslated > height) height += heightTranslated - height;
            }
        }
    ...
    {
        if (this is not ILogicalScrollable scrollable) return;
